...
#### 사용자는 자신의 마스터 장치(스마트폰)를 소지한다. 마스터 장치는 슬레이브 장치(무선 이어폰)와 페어링 된다. 사용자는 페어링 과정에 마스터 장치를 통해 슬레이브 장치의 NFT를 지갑에 생성하게 된다. 공개키와 개인키를 쌍으로 생성하여 마스터 장치 내부에 개인키를 저장한다. 이때 슬레이브 장치의 NFT는 장치에 내장된 고유한 MAC 주소를 포함한다. 
...
NBAS는 장치 등록, 장치 연결, 장치 양도, 초기화 등의 4가지 기능을 제공한다. 그림 10은 NBAS에서 제공하는 4가지 기능들에 대한 흐름도를 나타낸 것이다
